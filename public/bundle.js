  ...
  switch (action.type) {
    case 'ADD_ITEM':
      if (order.find(function (item) {
        ...
        var found = order.find(function (item) {
          return item.id === action.id;
        });
      ...
      return [].concat(_toConsumableArray(order), [{
        id: action.id,
        name: action.name,
        price: action.price,
        quantity: 1
...
var App = function App(props) {
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      ...
      initialOrder = _useState2[0],
      setInitialOrder = _useState2[1];
  ...
  var handleSubmitModification = function handleSubmitModification(event, newQuantity, itemId) {
    event.preventDefault();
    dispatch({
      type: 'MODIFY_ITEM',
...
var Order = function Order(props) {
  var initialTotal = 0;
  var totalPrice = props.order.reduce(function (previousValue, currentValue) {
    return previousValue + currentValue.price * currentValue.quantity;
  }, initialTotal);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "order"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", null, "Your Order"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("ul", null, props.order.map(function (item, index) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("li", {
      key: index
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h3", null, item.name), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "$", item.price), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "quantity: ", item.quantity), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", {
      onClick: function onClick(e) {
        return props.handleRemoveFromOrder(e, item.id);
      }
    }, "Remove Item"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", {
      onClick: function onClick(e) {
        return props.handleModifyOrderItem(e, item);
      }
    }, "Modify Item"));
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h3", null, "Total: ", totalPrice));
};
...
var OrderItemModifier = function OrderItemModifier(props) {
  ...
  var handleNewValue = function handleNewValue(e) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    ...
    className: "modal"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", null, "Modify this Item"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h4", null, props.item.name), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("form", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
    onChange: function onChange(event) {
      return handleNewValue(event);
    },
    type: "number",
    min: "1",
    value: quantity
    ...
    onClick: function onClick(event) {
      return props.handleSubmitModification(event, quantity, props.item.id);
    }
  }, "Done"))));
};
